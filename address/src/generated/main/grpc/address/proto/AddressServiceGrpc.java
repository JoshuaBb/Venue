...
public final class AddressServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<address.proto.GetAddressRequest,
      address.proto.GetAddressResponse> getGetAddressesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAddresses",
      requestType = address.proto.GetAddressRequest.class,
      responseType = address.proto.GetAddressResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<address.proto.GetAddressRequest,
      address.proto.GetAddressResponse> getGetAddressesMethod() {
    io.grpc.MethodDescriptor<address.proto.GetAddressRequest, address.proto.GetAddressResponse> getGetAddressesMethod;
    if ((getGetAddressesMethod = AddressServiceGrpc.getGetAddressesMethod) == null) {
      synchronized (AddressServiceGrpc.class) {
        if ((getGetAddressesMethod = AddressServiceGrpc.getGetAddressesMethod) == null) {
          AddressServiceGrpc.getGetAddressesMethod = getGetAddressesMethod =
              io.grpc.MethodDescriptor.<address.proto.GetAddressRequest, address.proto.GetAddressResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAddresses"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  address.proto.GetAddressRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  address.proto.GetAddressResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AddressServiceMethodDescriptorSupplier("GetAddresses"))
              .build();
        }
      }
    }
  ...
  public static abstract class AddressServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAddresses(address.proto.GetAddressRequest request,
        io.grpc.stub.StreamObserver<address.proto.GetAddressResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                address.proto.GetAddressRequest,
                address.proto.GetAddressResponse>(
  ...
  public static final class AddressServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AddressServiceBlockingStub> {
    ...
    /**
     */
    public address.proto.GetAddressResponse getAddresses(address.proto.GetAddressRequest request) {
  ...
  public static final class AddressServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AddressServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<address.proto.GetAddressResponse> getAddresses(
        address.proto.GetAddressRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetAddressesMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_ADDRESSES = 0;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ADDRESSES:
          serviceImpl.getAddresses((address.proto.GetAddressRequest) request,
              (io.grpc.stub.StreamObserver<address.proto.GetAddressResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AddressServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return address.proto.AddressOuterClass.getDescriptor();
    }
